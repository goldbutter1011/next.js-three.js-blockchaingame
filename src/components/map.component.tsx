...
//add mapcontrols - butter
import { MapControls } from '../three/MapControls';
//end
...
async function setup({ onAreaSelect, locations, setLocations, deck }) {
  ...
  const textureLoader_cloud = new THREE.TextureLoader();//textureLoader changed to textureLoader_cloud
  const cloudTexture = textureLoader_cloud.load('/cloud.jpg', function (texture) {
  ...
  // scaling the map size - butter
  group.scale.set(0.25, 0.3, 0.25);
